...
<template>
  <div class="min-h-screen font-sans relative overflow-hidden flex items-center justify-center" @mousemove="handleMouseMove">
    <!-- Dynamic Background -->
    ...
    <div class="max-w-6xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center justify-center gap-12 py-12">
      <div ref="heroTitle" class="flex flex-col gap-6 max-w-4xl">
        <h1 class="font-rexlia text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-wider leading-none select-none countdown-fade">
        ...
        <p class="text-brand-grey text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed countdown-fade">
